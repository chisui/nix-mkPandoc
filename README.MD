[![build examples unstable](https://github.com/chisui/nix-mkPandoc/actions/workflows/buildExamples.yml/badge.svg)](https://github.com/chisui/nix-mkPandoc/actions/workflows/buildExamples.yml)
